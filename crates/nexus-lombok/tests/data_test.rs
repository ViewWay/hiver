//! Comprehensive tests for all nexus-lombok derive macros.
//! nexus-lombok 所有派生宏的综合测试。
//!
//! Covers: Data, Getter, Setter, AllArgsConstructor, NoArgsConstructor,
//! Builder, Value, With — including edge cases and error paths.

use nexus_lombok::{Data, Getter, Setter, AllArgsConstructor, NoArgsConstructor, Builder, Value, With};
...
/// Test Getter skips fields annotated with #[get] or #[skip].
/// 测试 Getter 跳过标注了 #[get] 或 #[skip] 的字段。
#[test]
...
/// Test Setter skips fields annotated with #[set] or #[skip].
/// 测试 Setter 跳过标注了 #[set] 或 #[skip] 的字段。
#[test]
...
/// Test multiple derive macros can coexist on the same struct.
/// 测试多个派生宏可在同一结构体上共存。
#[test]
