...
// ============================================================================
// Spring stereotype macros (nexus_main, main, controller, service, etc.)
// ============================================================================

#[proc_macro_attribute]
pub fn nexus_main(attr: TokenStream, item: TokenStream) -> TokenStream {
    spring_stereotype::nexus_main(attr, item)
}
