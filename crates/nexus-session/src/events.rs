...
//!
//! ```rust,ignore
//! use nexus_session::events::{SessionEventPublisher, SessionEventListener, LoggingSessionListener};
//!
...
///
/// ```rust,ignore
/// use nexus_session::events::{SessionEventListener, SessionEvent};
///
...
///
/// ```rust,ignore
/// use nexus_session::events::{SessionEventPublisher, LoggingSessionListener};
///
/// let publisher = SessionEventPublisher::new();
/// publisher.add_listener(Arc::new(LoggingSessionListener));
///
...
///
/// ```rust,ignore
/// use nexus_session::events::{ConcurrentSessionControl, ConcurrentSessionStrategy};
///
