...
pub struct RedisSessionStore {
    /// Redis client
    /// Redis客户端
    client: Arc<nexus_data_redis::RedisClient>,
...
impl RedisSessionStore {
    ...
    /// 创建新的Redis会话存储
    pub fn new(client: nexus_data_redis::RedisClient) -> Self {
        Self {
...
pub struct MongoSessionStore {
    /// MongoDB client
    /// MongoDB客户端
    client: Arc<nexus_data_mongodb::MongoClient>,
...
impl MongoSessionStore {
    ...
    /// 创建新的MongoDB会话存储
    pub fn new(client: nexus_data_mongodb::MongoClient) -> Self {
        Self {
            client: Arc::new(client),
