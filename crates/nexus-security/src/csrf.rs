...
//!
//! ```rust,no_run,ignore
//! use nexus_security::csrf::{CsrfProtectionConfig, CsrfValidator, InMemoryCsrfTokenRepository};
//!
...
///
/// ```rust,no_run,ignore
/// use nexus_security::csrf::{CsrfValidator, CsrfProtectionConfig, InMemoryCsrfTokenRepository};
/// use http::Method;
///
/// let config = CsrfProtectionConfig::default();
