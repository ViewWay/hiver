...
//!
//! ```rust,ignore
//! use nexus_data_commons::specification::{Specifications, SpecValue};
//!
...
///
/// ```rust
/// use nexus_data_commons::specification::SpecValue;
///
...
///
/// ```rust
/// use nexus_data_commons::specification::{Predicate, SpecValue};
///
...
///
/// ```rust,ignore
/// use nexus_data_commons::specification::{Specification, Predicate, SpecValue};
///
...
///
/// ```rust
/// use nexus_data_commons::specification::{Specifications, SpecValue, Specification};
///
/// let spec = Specifications::where_clause()
///     .eq("status", SpecValue::String("active".into()))
///     .gt("age", SpecValue::I64(18))
...
///
/// ```rust
/// use nexus_data_commons::specification::{SpecFactories, SpecValue, Specification};
///
...
///
/// ```rust,ignore
/// use nexus_data_commons::specification::{JpaSpecificationExecutor, Specification, SpecValue};
