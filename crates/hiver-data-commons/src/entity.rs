...
///
/// ```rust,no_run,ignore
/// use hiver_data_commons::AggregateRoot;
///
/// #[derive(Debug, Clone)]
/// struct User {
///     id: i32,
...
///
/// ```rust,no_run,ignore
/// use hiver_data_commons::Auditable;
...
///
/// ```rust,no_run,ignore
/// use hiver_data_commons::Versioned;
///
/// #[derive(Debug, Clone)]
...
///
/// ```rust,no_run,ignore
/// use hiver_data_commons::SoftDeletable;
/// use chrono::{DateTime, Utc};
///
/// #[derive(Debug, Clone)]
...
///
/// ```rust,no_run,ignore
/// use hiver_data_commons::{EntityWithLifecycle, LifecycleEvent};
///
...
///
/// ```rust,no_run,ignore
/// use hiver_data_commons::TableName;
///
/// struct User {
///     id: i32,
///     name: String,
...
///
/// ```rust,no_run,ignore
/// use hiver_data_commons::ColumnName;
///
/// struct User {
///     id: i32,
///     user_name: String,
