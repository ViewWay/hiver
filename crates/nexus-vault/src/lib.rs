//! nexus-vault — Spring Vault equivalent for `HashiCorp` Vault secrets management
//! nexus-vault — `HashiCorp` Vault 密钥管理（Spring Vault 等价实现）
//!
//! # Overview / 概述
//!
//! `nexus-vault` provides a complete Rust client for `HashiCorp` Vault,
//! equivalent to Spring Vault in the Java/Spring ecosystem.
//!
//! `nexus-vault` 提供完整的 `HashiCorp` Vault Rust 客户端，
