...
///
/// ```rust,ignore
/// use nexus_data_commons::auditing::CreatedDate;
///
/// struct User {
...
///
/// ```rust,ignore
/// use nexus_data_commons::auditing::LastModifiedDate;
///
/// struct User {
...
///
/// ```rust,ignore
/// use nexus_data_commons::auditing::CreatedBy;
///
/// struct User {
...
///
/// ```rust,ignore
/// use nexus_data_commons::auditing::LastModifiedBy;
///
/// struct User {
...
///
/// ```rust
/// use nexus_data_commons::auditing::AuditorAware;
///
...
///
/// ```rust,ignore
/// use nexus_data_commons::auditing::AuditingEntity;
///
/// struct User {
...
///
/// ```rust
/// use nexus_data_commons::auditing::{AuditingHandler, AuditorAware, AuditingEntity};
/// use chrono::{DateTime, Utc};
///
/// struct TestAuditor;
...
///     fn set_created_at(&mut self, ts: DateTime<Utc>) { self.created_at = Some(ts); }
///     fn updated_at(&self) -> Option<DateTime<Utc>> { self.updated_at }
///     fn set_updated_at(&mut self, ts: DateTime<Utc>) { self.updated_at = Some(ts); }
///     fn created_by(&self) -> Option<&str> { self.created_by.as_deref() }
///     fn set_created_by(&mut self, user: Option<String>) { self.created_by = user; }
///     fn updated_by(&self) -> Option<&str> { self.updated_by.as_deref() }
///     fn set_updated_by(&mut self, user: Option<String>) { self.updated_by = user; }
