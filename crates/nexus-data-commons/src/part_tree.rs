...
//!
//! ```rust
//! use nexus_data_commons::part_tree::PartTree;
//!
//! let tree = PartTree::parse("findByNameAndAgeGreaterThanOrderByNameDesc")
...
impl PartTreeParser {
    ...
    fn extract_subject(&mut self) -> Result<(), String> {
        ...
        Err(format!(
            "Invalid subject in method name '{}'. Must start with find, read, get, query, count, exists, delete, or stream",
            self.remaining
        ))
    }
