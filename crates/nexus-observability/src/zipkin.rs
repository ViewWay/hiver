...
//!
//! ```rust,no_run,ignore
//! use nexus_observability::zipkin::{ZipkinExporter, ZipkinConfig};
//!
...
mod tests {
    ...
    #[test]
    fn test_from_nexus_span_server() {
    ...
    #[test]
    fn test_from_nexus_span_internal() {
    ...
    #[test]
    fn test_from_nexus_span_with_parent() {
    ...
    #[test]
    fn test_from_nexus_span_with_events() {
