...
///
/// ```rust,ignore
/// use nexus_events::{ApplicationEvent, EventListener};
///
/// struct MyListener;
///
/// impl MyListener {
...
pub use nexus_events_macros::EventListener;
...
///
/// ```rust,ignore
/// use nexus_events::{ApplicationEvent, TransactionalEventListener};
///
/// struct MyListener;
///
/// impl MyListener {
...
/// }
/// ```
pub use nexus_events_macros::TransactionalEventListener;
...
mod tests {
    ...
    use crate::registry::{EventFilter, PassAllFilter};
