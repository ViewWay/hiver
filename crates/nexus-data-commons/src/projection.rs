...
//!
//! ```rust,ignore
//! use nexus_data_commons::projection::{ProjectionField, ProjectionTransformer};
//!
//! let fields = vec![
...
///
/// ```rust
/// use nexus_data_commons::projection::ProjectionField;
///
...
///
/// ```rust,ignore
/// use nexus_data_commons::projection::Projection;
///
...
///
/// ```rust,ignore
/// use nexus_data_commons::projection::ProjectionTransformer;
///
...
///
/// ```rust
/// use nexus_data_commons::projection::DtoProjection;
///
...
///
/// ```rust,ignore
/// use nexus_data_commons::projection::ClosedProjection;
///
/// #[derive(Debug, Clone)]
/// struct NameDto {
///     name: String,
