...
///
/// ```rust,no_run,ignore
/// use hiver_security::context::SecurityContextGuard;
/// use hiver_security::SecurityContext;
/// use hiver_security::Authentication;
///
...
///
/// ```rust,no_run,ignore
/// use hiver_security::context::set_security_context;
/// use hiver_security::SecurityContext;
///
/// let ctx = SecurityContext::new();
...
///
/// ```rust,no_run,ignore
/// use hiver_security::context::with_security_context;
/// use hiver_security::SecurityContext;
///
/// let ctx = SecurityContext::new();
...
///
/// ```rust,no_run,ignore
/// use hiver_security::context::with_security_context_async;
/// use hiver_security::SecurityContext;
///
/// let ctx = SecurityContext::new();
