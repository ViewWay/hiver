...
///
/// ```
/// use nexus_core::conditional::ConditionContext;
/// use std::collections::HashMap;
///
...
///
/// ```
/// use nexus_core::conditional::{Condition, ConditionContext};
///
/// struct AlwaysTrue;
///
...
///
/// ```
/// use nexus_core::conditional::{ConditionalOnProperty, Condition, ConditionContext};
/// use std::collections::HashMap;
///
/// let ctx = ConditionContext::new()
///     .with_properties(HashMap::from([
...
///
/// ```
/// use nexus_core::conditional::{ConditionalOnMissingBean, Condition, ConditionContext};
/// use std::any::TypeId;
///
/// let ctx = ConditionContext::new()
...
///
/// ```
/// use nexus_core::conditional::{ConditionalOnBean, Condition, ConditionContext};
/// use std::any::TypeId;
///
/// struct DataSource;
/// let ctx = ConditionContext::new()
...
///
/// ```
/// use nexus_core::conditional::{ProfileCondition, Condition, ConditionContext};
///
/// let ctx = ConditionContext::new()
///     .with_profiles(vec!["production".to_string()]);
///
...
///
/// ```
/// use nexus_core::conditional::{AllConditions, ConditionalOnProperty, ProfileCondition, Condition, ConditionContext};
/// use std::collections::HashMap;
///
/// let ctx = ConditionContext::new()
///     .with_properties(HashMap::from([
...
///
/// ```
/// use nexus_core::conditional::{AnyCondition, ProfileCondition, Condition, ConditionContext};
///
/// let ctx = ConditionContext::new()
...
///
/// ```
/// use nexus_core::conditional::{NotCondition, ProfileCondition, Condition, ConditionContext};
///
/// let ctx = ConditionContext::new()
///     .with_profiles(vec!["production".to_string()]);
///
