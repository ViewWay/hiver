...
//!
//! ```rust,no_run,ignore
//! use nexus_security::data_scope::{DataScope, DataScopeRule, DataScopeType, DataScopeApply};
//!
...
///
/// ```rust,no_run,ignore
/// use nexus_security::data_scope::DataScopeRule;
///
...
///
/// ```rust,no_run,ignore
/// use nexus_security::data_scope::{DataScope, DataScopeContext};
///
/// let scope = DataScope::dept_and_sub(vec![100, 101, 102]);
/// let ctx = DataScopeContext::new(scope, 1001, 100);
///
/// let result = nexus_security::data_scope::with_data_scope(ctx, || {
...
/// let ctx = DataScopeContext::new(scope, 1001, 100);
///
/// let result = nexus_security::data_scope::with_data_scope_async(ctx, || async {
///     some_async_fn().await;
///     let current = nexus_security::data_scope::get_data_scope().await;
...
///
/// ```rust,no_run,ignore
/// use nexus_security::data_scope::default_scope_resolver;
/// use nexus_security::data_scope::DataScopeMiddleware;
///
...
///
/// ```rust,no_run,ignore
/// use nexus_security::data_scope::build_data_scope_authority;
/// use nexus_security::data_scope::DataScopeType;
///
