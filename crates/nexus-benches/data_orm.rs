...
use nexus_data_rdbc::QueryParam;
...
impl Model for User {
    ...
    fn primary_key(&self) -> nexus_data_orm::prelude::Result<String> {
        Ok("1".to_string())
    }

    fn set_primary_key(&mut self, _value: String) -> nexus_data_orm::prelude::Result<()> {
        Ok(())
    }
}
