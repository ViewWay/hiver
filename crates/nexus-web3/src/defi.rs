...
//!
//! ```rust,no_run,ignore
//! use nexus_web3::defi::{Erc20, UniswapV2Router};
...
use crate::contract::{ContractError, FunctionSelector};
...
impl UniswapV2Router {
    ...
    /// Selector for `addLiquidity(address,address,uint256,uint256,uint256,uint256,address,uint256)`.
    /// `addLiquidity(...)` 的选择器。
