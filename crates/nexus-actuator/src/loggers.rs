...
mod tests {
    ...
    fn test_register_and_set() {
        ...
        mgr.register("nexus::http", LogLevel::Debug);
        assert_eq!(mgr.get("nexus::http").unwrap().effective_level, LogLevel::Debug);
        mgr.set_level("nexus::http", LogLevel::Warn);
        assert_eq!(mgr.get("nexus::http").unwrap().effective_level, LogLevel::Warn);
    }
