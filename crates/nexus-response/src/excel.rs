...
//!
//! ```rust,ignore
//! use nexus_response::excel::{ExcelExportConfig, ExcelExporter, ExcelCell};
//!
...
///
/// ```rust,ignore
/// use nexus_response::excel::{ExcelTable, ExcelCell};
///
/// struct User {
///     name: String,
///     age: u32,
...
///
/// ```rust,ignore
/// use nexus_response::excel::{ExcelExportConfig, ExcelTable, ExcelCell, export_to_excel};
///
...
mod tests {
    ...
    fn test_write_to_file() {
        ...
        let path = tmp_dir.join("nexus_excel_test.xlsx");
