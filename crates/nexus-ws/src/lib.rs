//! nexus-ws — Spring Web Services — SOAP/WSDL contract-first web services
//! nexus-ws — SOAP/WSDL 契约优先 Web 服务
//!
//! # Overview / 概述
//!
//! `nexus-ws` provides SOAP web services with contract-first development,
//! message dispatching, XML marshalling, WSDL generation, and WS-Security.
//! Equivalent to: Spring Web Services
//!
//! `nexus-ws` 提供SOAP Web服务，支持契约优先开发、消息调度、XML编组、WSDL生成和WS-Security。
